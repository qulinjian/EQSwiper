...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return"("+((e=>{
...
contains:[{begin:/\\./}]}]}}})());hljs.registerLanguage("python",(()=>{"use strict";function e(e){
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
contains:g.concat([{begin:/\.$/}])}}})());hljs.registerLanguage("css",(()=>{"use strict"
